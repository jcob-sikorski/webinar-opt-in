...
export function ThankYouVideoSection({
  ...
  return (
    <section className="relative w-full bg-white font-sans selection:bg-blue-200 flex flex-col items-center overflow-x-hidden pt-3 pb-12 px-4 sm:px-6">
      <div className="mx-auto flex w-full max-w-[24rem] sm:max-w-[28rem] flex-col items-center">
        
        {/* Top 72% Progress Bar */}
        <div className="w-full mb-4">
        <div className="relative h-3.5 sm:h-4 w-full overflow-hidden rounded-full bg-[#edf4ff] border border-[#c7ddfd] shadow-2xs">
            {/* Blue Fill */}
            <div
            className="h-full bg-[#1665f5]"
            style={{ width: "72%" }}
            />
        ...
        {/* Headline */}
        <h1 className="mx-auto w-full text-center text-[1.12rem] min-[390px]:text-[1.25rem] sm:text-[1.45rem] font-black uppercase leading-[1.2] tracking-tight text-[#0c1e38]">
          Congrats, You&apos;re Registered For<br />
          <span className="text-[#1665f5]">{workshopDateTime}</span>
        </h1>

        {/* Subheadline - Stretched Maximally Wide */}
        ...
        {/* Video Preview Box (No Play Button Overlay) */}
        <div className="mx-auto mt-4 sm:mt-5 w-full">
          <div className="relative aspect-[16/9] w-full overflow-hidden rounded-[14px] sm:rounded-[16px] border-[3.5px] sm:border-[4px] border-[#1665f5] bg-black shadow-[0_4px_25px_rgba(0,0,0,0.12)]">
            {videoUrl ? (
              <iframe
                src={videoUrl}
