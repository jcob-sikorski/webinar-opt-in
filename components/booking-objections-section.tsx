...
const OBJECTIONS: Objection[] = [
  ...
  },
  {
    ...
    answer:
      "To nie jest zdrada. To moment, w którym przestajesz być rzemieślnikiem, a stajesz się architektem. „Odcięcie” sugeruje, że tracisz kontrolę — jest odwrotnie. Dziś, jeśli stoisz na sali, to grafik ma kontrolę nad Tobą. W tym modelu Ty decydujesz, gdzie jesteś potrzebny, zamiast być potrzebny wszędzie naraz.",
  },
  {
