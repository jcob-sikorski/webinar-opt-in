...
export function HeroSection() {
  return (
    <section className="relative w-full overflow-x-hidden bg-white font-sans selection:bg-blue-200">
      <div className="mx-auto w-full max-w-[25rem] px-3.5 pt-2 pb-6 sm:max-w-[34rem] lg:max-w-6xl lg:px-8 lg:py-10">
        ...
        <div className="flex flex-col items-center lg:grid lg:grid-cols-12 lg:items-start lg:gap-10">
          ...
          {/* LEWA KOLUMNA: Copywriting, Timer & Social Proof */}
          <div className="flex w-full flex-col items-center text-center lg:col-span-7 lg:items-start lg:text-left">
            
            {/* Top Badge */}
            <div className="flex w-full max-w-[21.5rem] flex-col items-center justify-center rounded-2xl border-[1.5px] border-[#2563eb] bg-[#edf4ff] py-1 px-3 text-center shadow-xs sm:max-w-[23.5rem] lg:mx-0">
              <div className="flex items-center gap-2 text-[0.78rem] font-extrabold tracking-tight text-[#0f2864] sm:text-[0.85rem]">
            ...
            {/* Countdown Section */}
            <div className="mt-3.5 flex w-full flex-col items-center lg:items-start">
            ...
            {/* Social Proof (Ukryte na mobile pod timerem, przeniesione pod formularz na małych ekranach) */}
            <div className="mt-6 hidden flex-col items-start gap-2 lg:flex">
          ...
          {/* PRAWA KOLUMNA: Wbudowany formularz rejestracji */}
          <div id="zapis" className="mt-4 flex w-full scroll-mt-4 flex-col items-center lg:col-span-5 lg:mt-0">
            ...
            {/* Social proof na mobile umieszczone bezpośrednio pod formularzem */}
